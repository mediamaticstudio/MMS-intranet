...
export default function IdeasLogos() {
  return (
    <section className="bg-[#181818] py-20 px-6 md:px-20 border-t border-[#FDE68B]/5">
      <div className="max-w-7xl mx-auto">
        <center className="mb-12">
          <span className="text-[#FDE68B]/40 text-[10px] font-bold tracking-[0.4em] uppercase">Trusted by Global Brands</span>
        </center>
        <div className="flex flex-wrap items-center justify-center gap-12 md:gap-24 opacity-50 contrast-0 hover:contrast-100 transition-all duration-700 grayscale hover:grayscale-0">
          ...
          <motion.div whileHover={{ scale: 1.1 }} className="h-8 md:h-12 w-32 bg-[#FDE68B]/10 rounded-lg animate-pulse" />
          <motion.div whileHover={{ scale: 1.1 }} className="h-8 md:h-12 w-32 bg-[#FDE68B]/10 rounded-lg animate-pulse" />
          <motion.div whileHover={{ scale: 1.1 }} className="h-8 md:h-12 w-32 bg-[#FDE68B]/10 rounded-lg animate-pulse" />
          <motion.div whileHover={{ scale: 1.1 }} className="h-8 md:h-12 w-32 bg-[#FDE68B]/10 rounded-lg animate-pulse" />
          <motion.div whileHover={{ scale: 1.1 }} className="h-8 md:h-12 w-32 bg-[#FDE68B]/10 rounded-lg animate-pulse" />
