   ...
   return (
      <section className="bg-[#181818] py-24 px-6 flex flex-col items-center justify-center overflow-hidden border-t border-[#FDE68B]/5 relative">
         ...
         <div className="-mt-8 text-center relative z-10">
            {/* <span className="text-[#FDE68B] text-[10px] font-black tracking-[0.6em] uppercase mb-4 block opacity-40">WORKFLOW EXCELLENCE</span> */}
            <h2 className="text-4xl md:text-6xl font-black text-[#FDE68B] mb-6 uppercase tracking-tighter italic">WORKFLOW EXCELLENCE</h2>
            {/* <p className="text-[#FDE68B]/50 max-w-xl mx-auto text-sm leading-relaxed font-bold uppercase tracking-tight">
         ...
         <div className="max-w-4xl mx-auto text-center relative z-10 mb-24 h-[450px] w-[450px] flex items-center justify-center">
            ...
            >
               <span className="text-[10px] font-black text-[#181818] text-center leading-none uppercase tracking-widest mb-1">MMS</span>
               <span className="text-[14px] font-black text-[#181818] text-center leading-tight uppercase tracking-tighter italic">STRATEGY</span>
