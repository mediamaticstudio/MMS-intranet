...
export default function AboutMMS() {
  return (
    <section id="about-mms" className="bg-[#181818] py-24 px-6 md:px-16 relative overflow-hidden border-t border-[#DBE3E9]/5">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <span className="text-[#DBE3E9] text-[10px] font-normal tracking-[0.4em] uppercase">WHO WE ARE</span>
            ...
            <p className="text-[#DBE3E9]/60 text-[15px] font-normal leading-relaxed max-w-xl">
          ...
          {/* Right: Commitment */}
          <div className="flex items-start gap-5 p-8 rounded-3xl bg-[#DBE3E9]/5 border border-[#DBE3E9]/10 hover:bg-[#DBE3E9]/10 transition-all duration-500 self-center">
            <div className="w-14 h-14 rounded-full bg-[#DBE3E9] flex items-center justify-center text-[#181818] flex-shrink-0 animate-pulse shadow-lg shadow-[#DBE3E9]/20">
              <Rocket size={28} />
            </div>
            <div className="space-y-2">
              <h3 className="text-sm font-normal text-[#DBE3E9] tracking-tight uppercase">Our Commitment</h3>
              <p className="text-[#DBE3E9]/40 text-[10px] font-normal leading-relaxed tracking-widest">
        ...
        {/* Services Label */}
        <span className="text-[#DBE3E9]/35 text-[10px] font-normal tracking-[0.4em] mb-0 block">What We Do</span>
        ...
        <ul>
          {serviceList.map((service, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="w-11 h-11 rounded-xl bg-[#DBE3E9]/10 flex items-center justify-center text-[#DBE3E9] group-hover:bg-[#DBE3E9] group-hover:text-[#181818] group-hover:rotate-6 group-hover:scale-105 transition-all duration-350 relative z-10">
                {service.icon}
              </div>

              {/* Text */}
              <div className="relative z-10">
                <p className="text-[13px] font-normal tracking-[0.08em] text-[#DBE3E9] mb-1 group-hover:tracking-[0.12em] transition-all duration-300">
                  {service.title}
                </p>
