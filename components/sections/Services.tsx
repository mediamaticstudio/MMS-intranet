...
const services = [
  { title: '2D/3D ANIMATION', category: 'MOTION GRAPHICS & VFX', desc: 'Crafting immersive visual narratives that breath life into your unique business vision.' },
  { title: 'APP DEVELOPMENT', category: 'CUSTOMIZED SOLUTIONS', desc: 'Developing high-performance, tailored applications that bridge the gap between vision and reality.' },
  { title: 'WEBSITE DESIGN', category: 'DIGITAL ARCHITECTURE', desc: 'Premium responsive websites built with precision and aligned with Fortune 2030 aspirations.' },
  { title: 'DIGITAL MARKETING', category: 'BRAND VISIBILITY', desc: 'Enhancing global reach through data-driven strategies and seamless brand management.' },
  { title: 'WEB HOSTING', category: '99.99% UPTIME GUARANTEE', desc: 'Reliable, secure, and cost-effective hosting solutions for enterprise-grade performance.' }
]
        ...
        <div className="md:w-2/3 space-y-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group p-12 rounded-[2.5rem] bg-[#FDE68B]/5 border border-[#FDE68B]/10 hover:bg-[#FDE68B] transition-all duration-700 flex flex-col md:flex-row items-center justify-between cursor-pointer shadow-xl shadow-transparent hover:shadow-[#FDE68B]/20"
            >
